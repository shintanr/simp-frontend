...
const [videoSourceType, setVideoSourceType] = useState<'file' | 'youtube'>('file');
  ...
  const fetchModules = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch("https://simp-backend-production.up.railway.app/admin/get/modul/9");
      if (!response.ok) {
  ...
  try {
    const url = `https://simp-backend-production.up.railway.app/api/submodul/quiz-eldas/${submoduleId}`;
...
const handleAddSubmodule = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const response = await fetch('https://simp-backend-production.up.railway.app/admin/post/submodul/eldas', {
      method: 'POST',
      body: formDataToSend,
    });
  ...
  const handleAddQuestion = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/post/quiz/eldas/${selectedSubmodule.id_submodul}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUpdateSubmodule = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/put/submodul/eldas/${selectedSubmodule.id_submodul}`, {
        method: "PUT",
        body: formDataToSend,
      });
...
const handleUpdateQuestion = async (e: React.FormEvent) => {
  ...
  const correctOptionIndex = formData.options.findIndex((option: { is_correct: any; }) => option.is_correct);
  ...
  try {
    const response = await fetch(`https://simp-backend-production.up.railway.app/admin/update/quiz/eldas/${quizId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDeleteSubmodule = async () => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/delete/submodul/eldas/${selectedSubmodule.id_submodul}`, {
        method: "DELETE",
      });
  ...
  const handleDeleteQuestion = async () => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/delete/quiz/eldas/${selectedQuestion.id_question}`, {
        method: "DELETE",
      });
