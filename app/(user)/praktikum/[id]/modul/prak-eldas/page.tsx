...
import Modul_1 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul1";
import Modul_2 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul2";
import Modul_3 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul3";
import Modul_4 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul4";
import Modul_5 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul5";
import Modul_6 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul6";
import Modul_7 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/modul/modul7";
import Quiz_1 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz1";
import Quiz_2 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz2";
import Quiz_3 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz3";
import Quiz_4 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz4";
import Quiz_5 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz5";
import Quiz_6 from "@/components/admin/praktikum/prak-lab-sister/prak-eldas/quiz/quiz6";
...
function PrakEldasPage() {
  ...
  const fetchModules = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch("https://simp-backend-production.up.railway.app/api/praktikum/modul/9");
      if (!response.ok) {
  ...
  const fetchSubmodules = useCallback(async (moduleId: number) => {
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/api/praktikum/submodul/prak-eldas/${moduleId}`);
      if (!response.ok) {
