...
import Modul_1 from "../../../prak-lab-rpl/prak-sbd/modul/modul1";
...
const getSubmoduleIcon = useCallback((submodule: { id_submodul: number; judul_submodul: string; video_url: string; pdf_url: any; }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between bg-gradient-to-br  from-purple-600 via-purple-700 to-indigo-800 p-4 text-white shadow-lg">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold">Praktikum Sistem Basis Data</h1>
          </div>
        </div>
      ...
      <div className="flex flex-grow relative pt-16">
        ...
        <button 
          className="fixed bottom-6 right-6 z-10 bg-blue-600 text-white p-3 rounded-full shadow-lg mt-8"
        ...
        <div 
          ...
          `}
        >
          <div className="flex justify-between items-center p-4 border-b border-gray-200 bg-gray-50 mt-8">
            {isSidebarExpanded ? (
          ...
          <div className="overflow-y-auto flex-grow scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 h-0">
            {loading ? (
              ...
              <div className="mb-6 rounded-xl overflow-hidden shadow-md border border-gray-200">
                ...
                <div className="text-center py-16 px-6">
                  <div className="relative">
                    ...
                    <h3 className="text-2xl font-semibold text-gray-800 mb-3">Welcome to Praktikum Sistem Basis Data</h3>
