...
const [videoSourceType, setVideoSourceType] = useState<'file' | 'youtube'>('file');
  ...
  const fetchModules = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch("https://simp-backend-production.up.railway.app/admin/get/modul/12");
      if (!response.ok) {
  ...
  const fetchSubmodules = useCallback(async (moduleId: number) => {
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/api/praktikum/submodul/prak-sdl/${moduleId}`);
      if (!response.ok) {
  ...
  try {
    const url = `https://simp-backend-production.up.railway.app/api/submodul/quiz-sdl/${submoduleId}`;
...
const handleAddSubmodule = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const response = await fetch('https://simp-backend-production.up.railway.app/admin/post/submodul/sdl', {
      method: 'POST',
      body: formDataToSend,
    });
  ...
  const handleAddQuestion = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/post/quiz/sdl/${selectedSubmodule.id_submodul}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUpdateSubmodule = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/put/submodul/sdl/${selectedSubmodule.id_submodul}`, {
        method: "PUT",
        body: formDataToSend,
      });
...
const handleUpdateQuestion = async (e: React.FormEvent) => {
  ...
  try {
    const response = await fetch(`https://simp-backend-production.up.railway.app/admin/update/quiz/sdl/${quizId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDeleteSubmodule = async () => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/delete/submodul/sdl/${selectedSubmodule.id_submodul}`, {
        method: "DELETE",
      });
  ...
  const handleDeleteQuestion = async () => {
    ...
    try {
      const response = await fetch(`https://simp-backend-production.up.railway.app/admin/delete/quiz/sdl/${selectedQuestion.id_question}`, {
        method: "DELETE",
      });
      ...
      <div className="flex items-center justify-between bg-[#0267FE] p-4 text-white shadow-lg">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold">Asprak Dashboard - Praktikum Sistem Digital Lanjutr</h1>
          </div>
        </div>
            ...
            <div className="p-3 border-b border-gray-100">
              <button 
                onClick={() => {
                  ...
                  setSelectedModule(null);
                  setSelectedSubmodule(null);
                  setFormData({ judul_modul: '', video_url: '', pdf_url: '', youtube_url: '', id_praktikum: 12 });
                }}
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-center py-12">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">
                  Welcome to Sistem Digital Lanjut Praktikum Admin Panel
                </h2>
