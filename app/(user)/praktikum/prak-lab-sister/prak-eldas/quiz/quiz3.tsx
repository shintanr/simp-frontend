...
export default function Quiz_3({ submodulId, userId }: QuizProps) {
  ...
  useEffect(() => {
    async function fetchQuiz() {
      try {
        const response = await fetch(`https://simp-backend-production.up.railway.app/api/submodul/quiz-eldas/${submodulId}`);
