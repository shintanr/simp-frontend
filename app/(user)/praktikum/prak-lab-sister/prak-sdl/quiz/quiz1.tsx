...
export default function Quiz_1_SDL({ submodulId, userId }: QuizProps) {
  ...
  useEffect(() => {
    async function fetchQuiz() {
      try {
        const response = await fetch(`https://simp-backend-production.up.railway.app/api/submodul/quiz-sdl/${submodulId}`);
